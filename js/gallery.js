...
galleryContainer.addEventListener('click', (event) => {
  ...
  const galleryImage = target.closest('.gallery-image');

  if (galleryImage) {
    const originalImage = galleryImage.getAttribute('data-source');
    const originalAlt = galleryImage.getAttribute('alt');
    currentImageLightBox = basicLightbox.create(`
